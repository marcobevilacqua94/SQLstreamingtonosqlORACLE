...
! if you get syntax errors try run "sed -i 's/\r//' ksqldb.sql" and "sed -i 's/\r//' deployksql.sh"
...
UPDATE STORE.ORDER_ITEMS SET QUANTITY = 20 WHERE PRODUCTID = 4
/

UPDATE STORE.ORDER_ITEMS SET QUANTITY = 20 WHERE PRODUCTID = 3
/

UPDATE STORE.ORDER_ITEMS SET QUANTITY = 20 WHERE PRODUCTID = 6
/

UPDATE STORE.ORDER_ITEMS SET QUANTITY = 20 WHERE PRODUCTID = 5
/
/
```
